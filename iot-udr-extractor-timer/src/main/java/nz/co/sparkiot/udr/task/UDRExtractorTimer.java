...
/**
* Timer Module to extract UDR from Actility ThingPark to IoT domain.
* @author rod
* @since 2019-02-13
*/
public class UDRExtractorTimer extends TimerSupplierInterface {
    ...
    public UDRExtractorTimer() throws ConfigurationException {
        UDRExtractorTimer.logger = getComponentLogger();
        UDRExtractorTimer.configMap = getConfigMap();
    }
