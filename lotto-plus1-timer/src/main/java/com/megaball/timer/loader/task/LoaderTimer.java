...
/**
* Timer module driver to load Lotto Plus 1 results.
* @author rod
* @since 2021-08
 */
public class LoaderTimer extends TimerSupplierInterface {
    ...
    public Class getJobClass() {
        return LottoPlus1LoaderTimerJob.class;
    }
    ...
    public String getName() {
        return "lotto-plus1-timer";
    }

    @Override
    public String getDescription() {
        return "This is a timer to load Lotto Plus 1 results.";
    }
}